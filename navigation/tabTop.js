              ...
              <View style={{flexDirection: 'row'}}>
                <PlaceholderContainer
                  ...
                  <View style={{marginTop: SIZES.base}}>
                    <Placeholder
                      style={[styles.placeholder, {width: '100%', height: 10}]}
                    />
                    <Placeholder
                      style={[styles.placeholder, {width: '70%', height: 10}]}
                    />
                  </View>
                </PlaceholderContainer>
              </View>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('Profile')}>
                <View style={{flexDirection: 'row'}}>
                  ...
                  <View style={{marginLeft: SIZES.padding}}>
                    ...
                    <Text style={{...FONTS.body4, color: COLORS.darkgrayText}}>
                      {user.WORK_POSITION ? user.WORK_POSITION : 'Nhân viên'}
                    </Text>
                  </View>
                </View>
              </TouchableOpacity>
